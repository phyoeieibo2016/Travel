...
class AppLocalization{
  ...
  Future load() async{
    String jsonStringValue = await rootBundle.loadString("i18n/${locale.languageCode}.json");
    Map<String, dynamic> mappedJson = json.decode(jsonStringValue);
    _localizatedValue = mappedJson.map((key, value) => MapEntry(key, value.toString()));
  }
